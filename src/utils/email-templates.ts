 ...
 */
export function generateSetPasswordEmail(name: string, setPasswordUrl: string): string {
  const content = `
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
      <tr>
        <td>
 ...
 */
export function generateResetPasswordEmail(name: string, resetPasswordUrl: string): string {
  const content = `
    <table role="presentation" cellpadding="0" cellspacing="0" border="0" width="100%">
      <tr>
        <td>
